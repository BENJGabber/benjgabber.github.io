document.addEventListener('DOMContentLoaded', () => {
    ...
    const manualTranslations = {
        en: {
            ...
            'about.subtitle': 'Student in Professional C.I.E.L Baccalaureate',
            'about.email': '📧 Email:',
            'about.phone': '📱 Phone:',
            ...
            'nav.home': 'Casa',
            'nav.about': 'Acerca de',
            'nav.journey': 'Viaje & experiencia',
            'nav.path': 'Viaje & experiencia',
            'nav.projects': 'Proyectos',
            'nav.articles': 'Artículos',
            'nav.forum': 'Foro',
            'nav.contact': 'Contacto',
            'hero.title': 'Hola, bienvenido a mi portafolio interactivo.',
            'hero.subtitle': 'Estudiante de último año del programa de bachillerato vocacional CIEL',
